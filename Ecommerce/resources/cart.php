        ...
        <tr>
         ...
         <img width ="100" src="../resources/{$product_image}">
          ...
          <td>&#36;{$row['product_price']}</td>
           <td>{$value}</td>
          <td>&#36;{$sub}</td>
           <td><a href="../resources/cart.php?remove={$row['product_id']}"><span class = "glyphicon glyphicon-minus"></span></a></td>
            <td><a href="../resources/cart.php?delete={$row['product_id']}"><span class = "glyphicon glyphicon-remove"></span></a></td>
           <td><a href="../resources/cart.php?add={$row['product_id']}"><span class = "glyphicon glyphicon-plus"></span></a></td>
    </tr>
...
while($row = fetch_array($query)) {
 ...
 $product_price = $row['product_price'];
  ...
  //insert order data into reports
